...
container_platforms=("amazon-2:centos-7" "amazon-2-arm:amazon-2-arm" "centos-7:centos-7" "centos-7-arm:centos-7-arm" "centos-8:centos-8" "centos-8-arm:centos-8-arm" "sles-15-arm:sles-15-arm" "sles-15:sles-15" "rhel-9:rhel-9" "rhel-9-arm:rhel-9-arm" "rhel-10:rhel-10" "rhel-10-arm:rhel-10-arm" "debian-9:debian-9" "debian-10:debian-9" "debian-11:debian-9" "ubuntu-1604:ubuntu-1604" "ubuntu-1804:ubuntu-1604" "ubuntu-2004:ubuntu-1604" "ubuntu-2204:ubuntu-1604" "ubuntu-2404:ubuntu-2404" "ubuntu-1804-arm:ubuntu-1804-arm" "ubuntu-2004-arm:ubuntu-2004-arm" "ubuntu-2204-arm:ubuntu-2204-arm" "ubuntu-2404-arm:ubuntu-2404-arm" "windows-2019:windows-2019" "rocky-8:rocky-8" "rocky-9:rocky-9" "amazon-2023:amazon-2023" "amazon-2023-arm:amazon-2023-arm")
...
then
  ...
  for platform in ${esoteric_build_platforms[@]}; do
    ...
    echo "  plugins:"
    echo "  - chef/omnibus#45bfede5aeb31812e5b3382c19140f9e7e8aeb72:"
    echo "      build: chef"
...
then
  ...
  for platform in ${esoteric_test_platforms[@]}; do
    ...
    echo "  agents:"
    echo "    queue: omnibus-${platform%:*}"
    if [ $build_key == "mac_os_x-13-arm64" ] || [ $build_key == "mac_os_x-14-arm64" ]
    then
      echo "    omnibus: tester"
      echo "    omnibus-toolchain: \"*\""
    fi
